 ...
 * 
 */
@WebServiceClient(name = "StudentServiceService", targetNamespace = "http://lab.rest.agh.edu.pl/", wsdlLocation = "http://localhost:8080/laby1/service?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STUDENTSERVICESERVICE_QNAME = new QName("http://lab.rest.agh.edu.pl/", "StudentServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/laby1/service?wsdl");
    ...
    public StudentService getStudentServicePort() {
        return super.getPort(new QName("http://lab.rest.agh.edu.pl/", "StudentServicePort"), StudentService.class);
    }
    ...
    public StudentService getStudentServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://lab.rest.agh.edu.pl/", "StudentServicePort"), StudentService.class, features);
    }
