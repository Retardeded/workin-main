 ...
 * 
 */
@WebServiceClient(name = "StudentServiceService", targetNamespace = "http://lab.soa.agh.edu.pl/", wsdlLocation = "http://localhost:8080/laby1/service?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STUDENTSERVICESERVICE_QNAME = new QName("http://lab.soa.agh.edu.pl/", "StudentServiceService");
    ...
    public StudentService getStudentServicePort() {
        return super.getPort(new QName("http://lab.soa.agh.edu.pl/", "StudentServicePort"), StudentService.class);
    }
    ...
    public StudentService getStudentServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://lab.soa.agh.edu.pl/", "StudentServicePort"), StudentService.class, features);
    }
